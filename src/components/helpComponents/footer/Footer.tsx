      ...
      <div className="mt-24 mb-7">
        <div className="grid  lg:grid-cols-10 md:grid-cols-8">
          <div className="lg:col-span-7 md:col-span-5 flex flex-col gap-5">
            ...
            This website is currently under construction and is being tested for optimal performance. We apologize for any inconvenience caused during this testing phase. Thank you for your patience and understanding.           </div>
